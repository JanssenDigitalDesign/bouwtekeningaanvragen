...
export default async function OverOnsPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Over ons"
        h1="Wij begeleiden u door het hele aanvraagproces heen"
        ...
        <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
          ...
          <Reveal delay={100} className="mt-8 space-y-5 text-brand-ink-muted">
            <p>
              ...
              zich richt op het hele traject rond het aanvragen van een omgevingsvergunning, niet
              alleen de tekening zelf.
            </p>
            <p>
              Een tekening is geen losse illustratie, maar een document dat moet kloppen — in
              maatvoering, constructie en presentatie — voordat een gemeente hem in behandeling
              neemt. Doordat we dagelijks met dit proces werken, weten we precies waar een toetser
              op let en waar een
